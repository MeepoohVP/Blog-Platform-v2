...
function Login() {
    return (
        ...
        <RiBearSmileFill className="h-20 w-auto mx-auto block text-[#7971EA] dark:text-[#9a93f7]" />
        ...
        <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm px-12">
            ...
            <div>
              <div className="flex items-center justify-between">
                ...
                <div className="text-sm">
                  <a href="#" className="font-semibold text-[#7971EA] dark:text-[#9a93f7] hover:text-indigo-500">
                    Forgot password?
                  </a>
                </div>
              </div>
          ...
          <p className="mt-10 text-center text-sm text-gray-500">
            No account?{' '}
            <Link to="/Blog-Platform/Register" className="font-semibold leading-6 text-[#7971EA] dark:text-[#9a93f7] hover:text-indigo-500">
              Register
            </Link>
          </p>
        </div>
