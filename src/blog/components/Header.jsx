...
function Header() {
  ...
  return (
    ...
    <header className={`w-full h-auto text-center pt-24 2xl:pt-36 text-[#3a3b3c]/[.7] dark:text-white relative bg-[#f5f5f5] dark:bg-[#181818]`}>
      ...
      <div className="relative pb-16 mt-8">
        <div className="h-96 w-[85%] md:w-3/4 2xl:w-2/3 2xl:hover:w-[67.2%] md:h-96 md:hover:w-[75.5%] mx-auto block bg-[#181818]/70 dark:bg-[#181818] Earth bg-center bg-cover hotblog rounded-lg duration-700 brightness-90 dark:brightness-95">
