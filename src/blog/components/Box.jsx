...
function Box(props) {
    return (
      ...
      <div className="allblog duration-500 w-2/3 lg:w-[30%] md:w-[45%] rounded-md overflow-hidden mx-auto mt-8 h-auto dark:bg-[#404040] solid border-[1.25px] border-black/40 hover:border-black dark:border-transparent">
