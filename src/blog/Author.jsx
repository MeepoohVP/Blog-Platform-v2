...
function Author() {
    return (
        ...
        <div className="dark:text-white/90 text-3xl mt-2">Author name</div>
        <div className="mt-1">
        <a href="#" className="mx-2 text-black/70 dark:text-white/90 text-3xl">
        ...
        <main className="bg-[#f5f5f5] dark:bg-[#181818] mb-16">
        <div className="dark:text-white text-5xl block mt-16 px-16 lg:px-36 2xl:px-80">Blog</div>
